...
static const _Sum_Request_type_support_symbol_names_t _Sum_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, te_demo, srv, Sum_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, te_demo, srv, Sum_Request)),
  }
};
...
{
  return &::te_demo::srv::rosidl_typesupport_cpp::Sum_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, te_demo, srv, Sum_Request)() {
  return get_message_type_support_handle<te_demo::srv::Sum_Request>();
}
...
static const _Sum_Response_type_support_symbol_names_t _Sum_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, te_demo, srv, Sum_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, te_demo, srv, Sum_Response)),
  }
};
...
{
  return &::te_demo::srv::rosidl_typesupport_cpp::Sum_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, te_demo, srv, Sum_Response)() {
  return get_message_type_support_handle<te_demo::srv::Sum_Response>();
}
...
static const _Sum_type_support_symbol_names_t _Sum_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, te_demo, srv, Sum)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, te_demo, srv, Sum)),
  }
};
...
{
  return &::te_demo::srv::rosidl_typesupport_cpp::Sum_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, te_demo, srv, Sum)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<te_demo::srv::Sum>();
}
