...
static const _Sum_Request_type_support_symbol_names_t _Sum_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, te_demo, srv, Sum_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, te_demo, srv, Sum_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, te_demo, srv, Sum_Request)() {
  return &::te_demo::srv::rosidl_typesupport_c::Sum_Request_message_type_support_handle;
}
...
static const _Sum_Response_type_support_symbol_names_t _Sum_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, te_demo, srv, Sum_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, te_demo, srv, Sum_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, te_demo, srv, Sum_Response)() {
  return &::te_demo::srv::rosidl_typesupport_c::Sum_Response_message_type_support_handle;
}
...
static const _Sum_type_support_symbol_names_t _Sum_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, te_demo, srv, Sum)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, te_demo, srv, Sum)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, te_demo, srv, Sum)() {
  return &::te_demo::srv::rosidl_typesupport_c::Sum_service_type_support_handle;
}
