...
static const _Add_Request_type_support_symbol_names_t _Add_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, te_demo, srv, Add_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, te_demo, srv, Add_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, te_demo, srv, Add_Request)() {
  return &::te_demo::srv::rosidl_typesupport_c::Add_Request_message_type_support_handle;
}
...
static const _Add_Response_type_support_symbol_names_t _Add_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, te_demo, srv, Add_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, te_demo, srv, Add_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, te_demo, srv, Add_Response)() {
  return &::te_demo::srv::rosidl_typesupport_c::Add_Response_message_type_support_handle;
}
...
static const _Add_type_support_symbol_names_t _Add_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, te_demo, srv, Add)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, te_demo, srv, Add)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, te_demo, srv, Add)() {
  return &::te_demo::srv::rosidl_typesupport_c::Add_service_type_support_handle;
}
