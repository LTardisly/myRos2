...
#include "te_demo/srv/detail/sum__rosidl_typesupport_fastrtps_c.h"
...
using _Sum_Request__ros_msg_type = te_demo__srv__Sum_Request;
...
size_t get_serialized_size_te_demo__srv__Sum_Request(
  const void * untyped_ros_message,
...
static uint32_t _Sum_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_te_demo__srv__Sum_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_te_demo
size_t max_serialized_size_te_demo__srv__Sum_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = te_demo__srv__Sum_Request;
    is_plain =
      (
...
static size_t _Sum_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_te_demo__srv__Sum_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, te_demo, srv, Sum_Request)() {
...
using _Sum_Response__ros_msg_type = te_demo__srv__Sum_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_te_demo
size_t get_serialized_size_te_demo__srv__Sum_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Sum_Response__ros_msg_type * ros_message = static_cast<const _Sum_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_te_demo__srv__Sum_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_te_demo
size_t max_serialized_size_te_demo__srv__Sum_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = te_demo__srv__Sum_Response;
    is_plain =
      (
...
static size_t _Sum_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_te_demo__srv__Sum_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, te_demo, srv, Sum_Response)() {
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, te_demo, srv, Sum)() {
  return &Sum__handle;
}
