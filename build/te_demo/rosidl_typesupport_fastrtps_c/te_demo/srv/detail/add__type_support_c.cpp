...
#include "te_demo/srv/detail/add__rosidl_typesupport_fastrtps_c.h"
...
using _Add_Request__ros_msg_type = te_demo__srv__Add_Request;
...
size_t get_serialized_size_te_demo__srv__Add_Request(
  const void * untyped_ros_message,
...
static uint32_t _Add_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_te_demo__srv__Add_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_te_demo
size_t max_serialized_size_te_demo__srv__Add_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = te_demo__srv__Add_Request;
    is_plain =
      (
...
static size_t _Add_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_te_demo__srv__Add_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, te_demo, srv, Add_Request)() {
...
using _Add_Response__ros_msg_type = te_demo__srv__Add_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_te_demo
size_t get_serialized_size_te_demo__srv__Add_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Add_Response__ros_msg_type * ros_message = static_cast<const _Add_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_te_demo__srv__Add_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_te_demo
size_t max_serialized_size_te_demo__srv__Add_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = te_demo__srv__Add_Response;
    is_plain =
      (
...
static size_t _Add_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_te_demo__srv__Add_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, te_demo, srv, Add_Response)() {
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, te_demo, srv, Add)() {
  return &Add__handle;
}
