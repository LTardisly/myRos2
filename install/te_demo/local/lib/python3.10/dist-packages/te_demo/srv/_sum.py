...
class Sum_Request(metaclass=Metaclass_Sum_Request):
    ...
    def __init__(self, **kwargs):
        ...
        self.aa = kwargs.get('aa', float())
        self.bb = kwargs.get('bb', float())
    ...
    def aa(self, value):
        if __debug__:
            assert \
                ...
                "The 'aa' field must be of type 'float'"
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'aa' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
        self._aa = value
    ...
    def bb(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'bb' field must be of type 'float'"
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'bb' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
        self._bb = value
...
class Sum_Response(metaclass=Metaclass_Sum_Response):
    ...
    def cc(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'cc' field must be of type 'float'"
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'cc' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
        self._cc = value
...
class Sum(metaclass=Metaclass_Sum):
    from te_demo.srv._sum import Sum_Request as Request
    from te_demo.srv._sum import Sum_Response as Response
