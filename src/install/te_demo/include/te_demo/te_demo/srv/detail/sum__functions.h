...
#ifndef TE_DEMO__SRV__DETAIL__SUM__FUNCTIONS_H_
#define TE_DEMO__SRV__DETAIL__SUM__FUNCTIONS_H_
 ...
 * calls
 * te_demo__srv__Sum_Request__init().
...
/**
 * It calls
 * te_demo__srv__Sum_Request__fini()
 ...
 * te_demo__srv__Sum_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * te_demo__srv__Sum_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * te_demo__srv__Sum_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_te_demo
...
/**
 * It calls
 * te_demo__srv__Sum_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_te_demo
...
/**
 * It allocates the memory for the array and calls
 * te_demo__srv__Sum_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_te_demo
...
/**
 * It calls
 * te_demo__srv__Sum_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // TE_DEMO__SRV__DETAIL__SUM__FUNCTIONS_H_
